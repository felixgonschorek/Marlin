...
#define STRING_CONFIG_H_AUTHOR "(Felix, Version1_1_1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "NetzgutPrinter"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 88.7 }
